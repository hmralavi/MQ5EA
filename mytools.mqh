...
enum ENUM_CUSTOM_TIMEFRAMES{
   CUSTOM_TIMEFRAMES_CHART = 0, // Chart TF
   CUSTOM_TIMEFRAMES_M1 = 1,  // 1 Min
   CUSTOM_TIMEFRAMES_M5 = 2,  // 5 Min
   CUSTOM_TIMEFRAMES_M10 = 3,  // 10 Min
   CUSTOM_TIMEFRAMES_M15 = 4,   // 15 Min
   CUSTOM_TIMEFRAMES_M30 = 5,  // 30 Min
   CUSTOM_TIMEFRAMES_H1 = 6,  // 1 Hr
   CUSTOM_TIMEFRAMES_H4 = 7,  // 4 Hr
   CUSTOM_TIMEFRAMES_H6 = 8,  // 6 Hr
   CUSTOM_TIMEFRAMES_H12 = 9,  // 12 Hr      
   CUSTOM_TIMEFRAMES_D1 = 10,  // 1 Day
   CUSTOM_TIMEFRAMES_W1 = 11,  // 1 Week
   CUSTOM_TIMEFRAMES_MN1 = 12,  // 1 Month
};


ENUM_TIMEFRAMES convert_tf(ENUM_CUSTOM_TIMEFRAMES ctf){
   switch(ctf){
      case CUSTOM_TIMEFRAMES_CHART:
         return _Period;
