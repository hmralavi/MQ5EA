...
#property indicator_label1    "BOS number"

#property indicator_type2 DRAW_NONE
#property indicator_label2    "Broken candle price"

#property indicator_type3 DRAW_NONE
#property indicator_label3    "Broken candle shift"
...
#property indicator_label6    "LossPoints"

#property indicator_type7 DRAW_NONE
#property indicator_label7    "NetProfitPoints"
...
//--- indicator buffers mapping
   SetIndexBuffer(0,ExtBosBuffer,INDICATOR_DATA);
   SetIndexBuffer(1,ExtBosPriceBuffer,INDICATOR_DATA);
   SetIndexBuffer(2,ExtBosShiftBuffer,INDICATOR_DATA);
   SetIndexBuffer(3,ExtWinRateBuffer,INDICATOR_DATA); 
   SetIndexBuffer(4,ExtProfitPointsbuffer,INDICATOR_DATA);
   SetIndexBuffer(5,ExtLossPointsBuffer,INDICATOR_DATA);
   SetIndexBuffer(6,ExtNetProfitPointsBuffer,INDICATOR_DATA);
